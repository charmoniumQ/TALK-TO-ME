...
from .util import split_include
...
def string2words_helper2(word: str) -> Iterable[str]:
    ...
    # However, in some special cases (such as URLs and smileys), I
    # will parse several non-alphanumerics in one token.  These tests
    # should be ordered from most probable to least, except where the
    # tests are non-disjoint.
